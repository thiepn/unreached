  ...
  return (
    <section class="saved-page" aria-labelledby="my-lists-title">
      ...
      <section class="saved-section saved-prayer-section" aria-labelledby="prayer-list-heading">
        ...
        <details class="saved-policy-note"><summary>How prayer-list data is stored</summary><p>Prayer practice stores only a small local identity snapshot, when the person was added, and the latest prayer timestamp if you choose to record one. Rotation and guided-session planning are derived from those existing timestamps and do not add totals, scores, streaks, deadlines, leaderboards, priority values, session histories, completion metrics, or public activity.</p></details>
      </section>
