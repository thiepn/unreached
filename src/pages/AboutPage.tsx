    ...
    <article class="about-page">
      ...
      <section class="about-section" aria-labelledby="method-heading">
        ...
        <ol class="about-method-list">
          ...
          <li><strong>Coverage beside aggregates.</strong><span>Population totals show how many country contexts actually have a known estimate. Country and map shares describe represented source records, not national census populations.</span></li>
      ...
      <section class="about-section" aria-labelledby="sources-heading">
        ...
        <div class="about-source-grid">
          <div><strong>PeopleGroups.org / IMB Global Research</strong><span class="about-source-status about-source-status--approved">Runtime active</span><p>Live mission-map, people, country and prayer-subject data is read directly through the public read-only API. Unreached does not publish a bundled static mirror, and linked third-party people photos remain excluded.</p><a href="https://peoplegroups.org/using-the-api/" target="_blank" rel="noreferrer">PeopleGroups.org API documentation</a></div>
      ...
      <section class="about-section about-release-state" aria-labelledby="release-heading">
        ...
        <p>The separate editorial-context dataset and legacy language/Scripture dataset remain independently gated until compatible production data sources and semantics are certified.</p>
