    ...
    <article class="about-page">
      ...
      <section class="about-section" aria-labelledby="sources-heading">
        ...
        <div class="about-source-grid">
          ...
          <div><strong>Joshua Project API</strong><span class="about-source-status about-source-status--gated">Phase 13 · post-3.0 gate</span><p>Phase 13 adds an optional, on-demand comparison for manually reviewed identity links only. The API key stays server-side; responses use no-store handling; data is not added to the Unreached corpus; and every rendered record includes linked Joshua Project attribution. Production activation remains blocked until the 3.0 Gate D prerequisite is satisfied and the Worker secret is configured.</p><a href="https://api.joshuaproject.net/terms_of_use" target="_blank" rel="noreferrer">Joshua Project terms</a></div>
      ...
      <section class="about-section about-release-state" aria-labelledby="release-heading">
        ...
        <p><a href="/unreached/privacy.html">Read the public privacy notice</a>. Source and licensing records were most recently reviewed for Phase 13 on <strong>17 September 2026</strong>.</p>
      </section>
