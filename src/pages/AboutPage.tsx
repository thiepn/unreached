  ...
  return (
    <article class="about-page">
      ...
      <section class="about-section about-release-state" aria-labelledby="release-heading">
        ...
        <p>The separate reviewed editorial-context dataset remains independently gated until its claim-review model is migrated safely from legacy people IDs to PeopleGroups PEIDs. ProgressBible translation-progress data and Ethnologue proprietary taxonomy remain separately permission-gated.</p>
