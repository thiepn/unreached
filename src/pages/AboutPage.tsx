  ...
  return (
    <article class="about-page">
      ...
      <section class="about-section about-release-state" aria-labelledby="release-heading">
        ...
        <p><a href="/unreached/privacy.html">Read the public privacy notice</a>. Source and licensing records were most recently reviewed on <strong>17 September 2026</strong>.</p>
      </section>
