...
const definitions = [
  ...
  ["Source history", "A bounded device-private sequence of distinct PeopleGroups.org source states observed by this browser. History starts when this device sees a record; earlier values are never backfilled, interpolated or inferred."],
    ...
    <article class="about-page">
      ...
      <section class="about-section" aria-labelledby="method-heading">
        ...
        <ol class="about-method-list">
          ...
          <li><strong>History is observed, never backfilled.</strong><span>Historical mission intelligence records only distinct source states this device actually observed. Repeated visits are de-duplicated, provider update dates are preserved, and no earlier trend point is invented from current data.</span></li>
